O projeto é um sistema web simples de login e gerenciamento de usuários, desenvolvido em PHP e MySQL. Na primeira etapa (CRUD 1), foi implementada a autenticação: o usuário digita login e senha, o sistema consulta o banco de dados e, se os dados estiverem corretos, inicia uma sessão e redireciona para a página inicial.
